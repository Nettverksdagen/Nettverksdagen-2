function createWheel(radius)
{
    ...
    const shuffledCandidates = shuffle(candidatesInOrder)
...
function createSector(id, radius, angle, rotation, color, label)
{
    for (var j = 0; j < Math.floor(angle/90); j++)
    {
        ...
        document.getElementById(id+"_"+j).style.width = radius + "px";
        document.getElementById(id+"_"+j).style.height = radius + "px";
        document.getElementById(id+"_"+j).style.marginTop = -radius + "px";
        document.getElementById(id+"_"+j).style.marginLeft = -radius + "px";
    }
    ...
    document.getElementById(String(id)).style.width = radius + "px";
    document.getElementById(String(id)).style.height = radius + "px";
    document.getElementById(String(id)).style.marginTop = -radius + "px";
    document.getElementById(String(id)).style.marginLeft = -radius + "px";
