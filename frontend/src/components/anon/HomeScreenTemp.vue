      ...
      <div class="hero-content">
        <div class="boxes">
          ...
          <!-- <router-link :to="{name: 'Program', hash: '#avslutningsmiddag'}" @click.native="scrollToId('avslutningsmiddag')"> -->
            <HomeScreenBox box-title="avslutningsmiddag" box-icon="glass-cheers-solid.svg" box-text="Nettverksdagene avsluttes med en avslutningsmiddag på Thon Hotel Prinsen. " class="box"/>
          <!-- </router-link> -->
          <!--  <b-link :to="'/program'"> -->
