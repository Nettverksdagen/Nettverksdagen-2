<template>
  <div class="anon-header">
    <div class="content" :class="scrolled ? 'box-shadow' : 'line-border'">
      ...
      <b-link :to="'/'" class="logo-link">
        <div class="side">
          <!-- <img class="newlogo" :src="dark ? '../../assets/textlogo_dark.gif' : '../../assets/textlogo_light.gif'"> -->
          ...
          <!-- <img class="newlogo" v-if="this.image" :key="this.image.id" :src="this.image.src"> -->
        </div>
      </b-link>
      <div class="side">
        <b-nav class="links">
          ...
          <b-nav-item class="round-button colorhover" title="Hjem" :to="{name: 'Home'}" active>
            <font-awesome-icon icon="home" class="faicon"></font-awesome-icon>
          </b-nav-item>
          <b-nav-item class="round-button colorhover" title="Info" :to="{name: 'About'}">
            <font-awesome-icon icon="info-circle" class="faicon"></font-awesome-icon>
          </b-nav-item>
          <b-nav-item class="round-button colorhover" title="Endre tema" v-on:click="toggleTheme">
            <font-awesome-icon icon="adjust" class="faicon"></font-awesome-icon>
          </b-nav-item>
       </b-nav>
       <Slider/>
      </div>
